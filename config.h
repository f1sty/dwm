 ...
 */
/* static const char *fonts[]                = { "FuraMono Nerd Font
 * Mono:size=8" }; */
...
static const char *termcmd[] = {"xterm", "-e", "tmstart", NULL};
static const char *takenote[] = {"xterm", "-class", "notes", "-e", "note", NULL};
static const char *todos[] = {"xterm", "-class", "todos", "-e", "calcurse", NULL};
...
static const char *cmus[] = {"xterm", "-n", "music", "-e", "cmus", NULL};
...
static const char *volume_down[] = {"pactl", "set-sink-volume", "0", "-5%",
                                    NULL};
static const char *toggle_mute[] = {"pactl", "set-sink-mute", "0", "toggle",
                                    NULL};
static const char *close_notification[] = {"dunstctl", "close-all", NULL};
/* static const char *move_right[]         = { "xdotool", "mousemove_relative",
 * "10", "0", NULL}; */
/* static const char *move_left[]          = { "xdotool", "mousemove_relative",
 * "--", "-10", "0", NULL}; */
/* static const char *move_up[]            = { "xdotool", "mousemove_relative",
 * "--", "0", "-10", NULL}; */
/* static const char *move_down[]          = { "xdotool", "mousemove_relative",
 * "0", "10", NULL}; */
...
static Key keys[] = {
    ...
    // { MODKEY|ControlMask           , XK_m                    , spawn , {.v =
    // xmouseless } }         ,
    /* { MODKEY|ControlMask           , XK_k                    , spawn , {.v =
       keynav } }             , */
    ...
    /* { MODKEY|ShiftMask             , XK_k                    , spawn , {.v =
       move_up} }             , */
    /* { MODKEY|ControlMask           , XK_g                    , spawn , {.v =
       click_right} }         , */
